...
while ( tickLabelPos <= rulerLength) {
  if (( tickLabelPos %50) == 0){
    newTickLabels.push( `<div class="tick tick-label" style="left: ${tickLabelPos}px;">${tickLabelPos}</div>`);
  } else if ( (tickLabelPos % 10 ) == 0) {
    newTickLabels.push( `<div class="tick tick-major" style="left: ${tickLabelPos}px;"></div>`)
  } else if ( (tickLabelPos % 5) == 0) {
    newTickLabels.push(`<div class="tick tick-minor" style="left: ${tickLabelPos}px;"></div>`)
  }
  tickLabelPos += 5;
}
...
while (tickLabelPos <= leftRulerEl.scrollHeight) {
  if (( tickLabelPos %50) == 0){
    newTickLabels.push( `<div class="tick tick-label" style="top: ${tickLabelPos}px;">${tickLabelPos}</div>`);
  } else if ( (tickLabelPos % 10 ) == 0) {
    newTickLabels.push( `<div class="tick tick-major" style="top: ${tickLabelPos}px;"></div>`)
  } else if ( (tickLabelPos % 5) == 0) {
    newTickLabels.push(`<div class="tick tick-minor" style="top: ${tickLabelPos}px;"></div>`)
  }
  tickLabelPos += 5;
}
