...
import { defaultWatermarkOptions, saveOptionsFn, getOptionsFn, uploadImageFn } from '../options.js'
...
function initGUI(){
  ...
  Object.assign(optionsParams, {
    ...
    url: options.id || '',
    size: parseFloat(options.size) || 100,
    ...
    resetDefault: ()=>{
      Object.assign(optionsParams, defaultWatermarkOptions, {name: 'Image Watermark'})
      applyJoppInit();
  ...
  gui.add(optionsParams, 'size', 10, 400).onChange(applyJoppInit);
